...
I built this to strengthen my full-stack development skills and to practice building websites from scratch. While building this website I focused on UI details and responsiveness, based on a design provided by Frontend Mentor in Figma.
<p>The frontend was built with Next.js, Tailwind CSS, and shadcn/ui to create a clean and modern user interface. Authentication was implemented using Better Auth to ensure secure access to user data.</p>  
